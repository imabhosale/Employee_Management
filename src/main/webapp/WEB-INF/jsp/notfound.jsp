...
<div class="container123">
    ...
    <div class="title">Sorry Record not Found
    </div>
...
<!--          <div class="input-box">
            <span class="details">Enter Employee ID</span>
            <input type="text"  name="a"  placeholder="Eneter id">
          </div>-->

<a href="http://localhost:6289/employeemanagement/dashboard">
<button class="up_search" type="submit " >Ok</button>
</a>
           </div>
