      ...
      <form action="addsalary" method="post">
        ...
        <div class="input-box">
            <span class="details">Grade</span>
                ...
                <select  class="dept"  name="grade">
        <option> Select Grade</option>
         
              <option>Pay Grade 1 </option>   
              <option>Pay Grade 2 </option>     
              <option>Pay Grade 3 </option>   
              <option>Pay Grade 4 </option>   
              <option>Pay Grade 5 </option>   
             
        </select>
          </div>
              <div class="input-box">
            <span class="details">Salary Per Month</span>
            <input type="text"  name="spm"required>
