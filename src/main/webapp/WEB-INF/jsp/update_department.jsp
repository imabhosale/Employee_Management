...
form .user-details .input-box{
  ...
  .user-details::-webkit-scrollbar{
    ...
    Integer m=(Integer)request.getAttribute("mrt");
          ...
          <% 
    String department1=(String)request.getAttribute("deptname");
    String id1=(String)request.getAttribute("deptid");
     
           %>
    <div class="title"> Update Department -->
    </div>
       
    <div class="content">
    <form action="updateeform" method="post">
        <div class="user-details">
         <div class="input-box">
            <span class="details">ID</span>
            <input type="text"  value="<%=id1%>" name="dept_id" required >
          </div>
       
              <div class="input-box">
            <span class="details">Department</span>
            <input type="text" value="<%=department1%>" name="dept_name">
          </div>
