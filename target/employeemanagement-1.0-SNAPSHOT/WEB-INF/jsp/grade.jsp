...
form .user-details .input-box{
  ...
  <div class="user-details">
    ...
    <div class="input-box">
      <span class="details"  id="content-holder"> Grade ID</span>
       <input type="text" placeholder="Enter Grade ID"  name="grade_id" required>
    </div>
    
       <div class="input-box">
      <span class="details">Grade Name</span>
      <input type="text" placeholder="Enter GradeName" name="grade_name"required >
    </div>
      <div class="input-box">
      <span class="details">Grade Short Name</span>
      <input type="text" placeholder="eg. A"name="grade_sn" required >
    </div>
       <div class="input-box">
      <span class="details">Basic salary</span>
      <input type="text" placeholder="eg. 50000"name="grade_basic" >
    </div>
     
    <div class="input-box">
      <span class="details">TA</span>
      <input type="text" name="grade_ta"  required>
    </div>
             
      <div class="input-box">
      <span class="details">DA</span>
      <input type="text" name="grade_da" >
    </div>
     <div class="input-box">
      <span class="details">HRA</span>
      <input type="text" name="grade_hra">
    </div>
     <div class="input-box">
      <span class="details">MA</span>
      <input type="text" name="grade_ma">
    </div>
     <div class="input-box">
      <span class="details">Bonus</span>
      <input type="text" name="grade_bonus">
    </div>
     <div class="input-box">
      <span class="details">PF</span>
      <input type="text" name="grade_pf">
    </div>
     <div class="input-box">
      <span class="details">PT</span>
      <input type="text" name="grade_pt">
    </div>
