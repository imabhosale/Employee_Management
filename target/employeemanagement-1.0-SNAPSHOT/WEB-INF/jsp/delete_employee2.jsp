...
form .user-details .input-box{
 ...
 <div class="container1">
    ...
    String id1=(String)request.getAttribute("ide");
 ...
 String mobile1=(String)request.getAttribute("mobile");
    ...
    <div class="content">
    <form action="deleteformprocess" method="post">
        <div class="user-details">
         <div class="input-box">
            ...
            <input type="text" value="<%=id1%>" name="a">
          ...
          <div class="input-box">
            ...
            <input type="text" value="<%=city1%>" name="doj">
          </div>
             <div class="input-box">
            <span class="details">Email Id</span>
            <input type="text" value="<%=email1%>" name="state">
          </div>
            <div class="input-box">
            <span class="details">Mobile no</span>
            <input type="text"  value="<%=mobile1%>" name="city">
          </div>
